...
namespace MeshSplitting.Splitables
{
	...
	public class Splitable : MonoBehaviour, ISplitable
	{
		...
		PlaneMath _splitPlane;
		MeshContainer[] _meshContainerStatic;
		IMeshSplitter[] _meshSplitterStatic;
		MeshContainer[] _meshContainerSkinned;
		IMeshSplitter[] _meshSplitterSkinned;

		bool _isSplitting = false;
		bool _splitMesh = false;
		...
		void UpdateMeshesInChildren (int i, GameObject go)
		{
		...
		static Material[] GetSharedMaterials (GameObject go)
		{
		...
		static void SetSharedMaterials (GameObject go, Material[] materials)
		{
			SkinnedMeshRenderer skinnedMeshRenderer = go.GetComponent<SkinnedMeshRenderer> ();
			if (skinnedMeshRenderer != null) {
		...
		static void SetMeshOnGameObject (GameObject go, Mesh mesh)
		{
			SkinnedMeshRenderer skinnedMeshRenderer = go.GetComponent<SkinnedMeshRenderer> ();
			if (skinnedMeshRenderer != null) {
		...
		static Mesh GetMeshOnGameObject (GameObject go)
		{
			SkinnedMeshRenderer skinnedMeshRenderer = go.GetComponent<SkinnedMeshRenderer> ();
			if (skinnedMeshRenderer != null) {
